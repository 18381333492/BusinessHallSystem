...
namespace DapperExtensions
{
    public interface IDatabase
    {
        ...
        int Update<T>(T entity, IDbTransaction transaction, int? commandTimeout = null) where T : class;
        int Update<T>(T entity, int? commandTimeout = null) where T : class;
    ...
    public class Database : IDatabase, IDisposable
    {
        ...
        public int Update<T>(T entity, IDbTransaction transaction, int? commandTimeout) where T : class
        {
            return _dapper.Update<T>(Connection, entity, transaction, commandTimeout);
        }

        public int Update<T>(T entity, int? commandTimeout) where T : class
        {
